module.exports = {
    ...
    run: async (client, message, args) => {
        const {Client, RichEmbed, Collection} = require('discord.js')
         ...
         if(vip === true) vip = Math.floor(Math.random() * 350) + 100, "Looks like you owned vip you will get extra 100 animebucks plus more chances to get more animebucks.";
         if (vip === null) vip = Math.floor(Math.random() * 200) + 1, "Looks like you don't own vip, you shoud buy it from the shop because you can get extra perks from owning it..";
         var beggingrandom = [
