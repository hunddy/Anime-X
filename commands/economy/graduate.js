module.exports = {
    ...
    if(db.fetch(`highschooldiploma_${message.author.id}`)) return message.channel.send(Embed3)
        ...
        .setColor("RANDOM")
        .setDescription(``)
        .addField('Situation', `As you walked down the aisle for your high school diploma the graduation march music started playing, ooked around remembering all the good times and bad times you had at the school all the hard work you putted into getting the diploma. `)
